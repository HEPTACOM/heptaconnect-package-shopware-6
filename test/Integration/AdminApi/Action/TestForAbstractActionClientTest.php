 ...
 * @covers \Heptacom\HeptaConnect\Package\Shopware6\Http\ErrorHandling\Exception\MethodNotAllowedException
...
final class TestForAbstractActionClientTest extends TestCase
{
    ...
    {
        $action = new BrokenActionClient(Factory::createAdminApiFactory()->getActionClientUtils());
