...
/**
 * Tag every package expectation service to collect them later in the collection service.
 ...
 */
final class AdminApiPackageExpectationRegistrationCompilerPass implements CompilerPassInterface
{
    /**
     * The tag, that is used to identify the services.
     */
    public const TAG_NAME = 'heptaconnect.package.shopware6.admin_api.package_expectation';
