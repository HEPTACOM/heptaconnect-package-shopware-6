...
abstract class AbstractActionClient
{
     ...
     */
    protected function addContextToken(RequestInterface $request, $contextTokenAware): RequestInterface
    {
        return $this->actionClientUtils->addContextToken($request, $contextTokenAware);
    }
