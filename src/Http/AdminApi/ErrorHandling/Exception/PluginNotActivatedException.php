...
final class PluginNotActivatedException extends AbstractRequestException implements RequestExceptionInterface
{
    ...
    public function __construct(
        ...
        $message = \sprintf('The plugin %s is not activated', $pluginName);
